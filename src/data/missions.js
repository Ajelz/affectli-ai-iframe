...
export const aiRecommendations = [
  {
    ...
    titleEn: "Assign audit team to Jumhouria Bank",
    entityAr: "مصرف الجمهورية",
    entity: "Jumhouria Bank",
    recommendationAr: "تعيين فريق متخصص في الرقابة المصرفية بقيادة أحمد الفيتوري",
    recommendationEn: "Assign specialized banking audit team led by Ahmed Al-Faituri",
    confidence: 91,
  ...
  },
  {
    ...
    titleEn: "Reallocate resources from Ministry of Finance team",
    entityAr: "وزارة المالية",
    entity: "Ministry of Finance",
    recommendationAr: "نقل مدقق واحد إلى مهمة وزارة الصحة الأكثر إلحاحاً",
    recommendationEn: "Transfer one auditor to urgent Ministry of Health mission",
    confidence: 78,
  ...
  },
  {
    ...
    titleEn: "Conflict of interest alert - National Commercial Bank",
    ...
    recommendationEn: "Replace auditor Noura Al-Barqawi due to discovered family relationship",
    confidence: 96,
